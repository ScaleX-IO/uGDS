...
typedef std::atomic<uint32_t> padded_struct_pc;
...
typedef struct
{
    std::atomic<uint32_t> head_lock;
    uint8_t pad0[28];
    std::atomic<uint32_t> tail_lock;
    uint8_t pad1[28];
    std::atomic<uint32_t> head;
    uint8_t pad2[28];
    std::atomic<uint32_t> tail;
    uint8_t pad3[28];
    std::atomic<uint32_t> tail_copy;
    uint8_t pad4[28];
    std::atomic<uint32_t> head_copy;
    uint8_t pad5[28];

    /* padded_struct<std::atomic<uint32_t>> head; */
    /* padded_struct<std::atomic<uint32_t>> tail; */
    std::atomic<uint32_t> in_ticket;
    uint8_t pad6[28];
    std::atomic<uint32_t> cid_ticket;
    //uint8_t pad7[28];
